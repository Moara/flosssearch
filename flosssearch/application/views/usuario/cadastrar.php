...
<div class="ls-login-parent">
  ...
  <?php echo form_open("usuario/cadastrar", array('role'=>'form', 'class' => 'ibox-body')); ?>
    <fieldset>

      <h3 style="text-align: center;"><strong>Create your account</strong></h3>

      <label class="ls-label">
        <b class="ls-label-text ls-hidden-accessible">Nome</b>
        <input class="ls-login-bg-user ls-field-lg" type="text" placeholder="Nome" name="nome" required autofocus>
      </label>

      <label class="ls-label">
        <b class="ls-label-text ls-hidden-accessible">E-mail</b>
        <input class="ls-login-bg-email ls-field-lg" type="email" placeholder="E-mail" name="email" required>
      </label>
      ...
      <input type="submit" value="Entrar" name="btn_cadastrar" class="ls-btn-primary ls-btn-block ls-btn-lg">
      <p class="ls-txt-center ls-login-signup"><a href="<?php echo base_url('usuario'); ?>">Login</a></p>
