      ...
      <div class="row bg">
        ...
        <div class="col-lg-8" style="min-height: 500px;">
          ...
          <p style="text-align: center; font-size: 1.8rem; line-height: 3rem; color: #9CADC5; font-weight: 300;">
            Through FLOSS SEARCH, we seek to assist teachers and students in the process of choosing open source projects hosted in GitHub used in software engineering education.
          </p>
